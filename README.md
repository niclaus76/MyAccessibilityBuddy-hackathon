...
**HTML Report** (format: `YYYY-MM-DDTHH-MM-SS-analysis-report-<url>.html`):
...
**Example filename:** `2026-01-13T14-30-52-analysis-report-www.ecb.europa.eu.html`
...
**CSV Report** (format: `prompt_comparison_YYYY-MM-DDTHH-MM-SS.csv`):
```
...
**Example filename:** `prompt_comparison_2026-01-24T15-08-52.csv`

**HTML Report** (format: `prompt_comparison_YYYY-MM-DDTHH-MM-SS.html`):
...
**Example filename:** `prompt_comparison_2026-01-24T15-08-52.html`

When GEO boost testing is enabled (`test_geo_boost: true`), filenames include `_geo_comparison` suffix:
- `prompt_comparison_2026-01-24T15-08-52_geo_comparison.csv`
- `prompt_comparison_2026-01-24T15-08-52_geo_comparison.html`

## Report Formats
### 1. Accessibility Compliance Reports
Generated when analyzing web pages for WCAG compliance.
**Format:** `YYYY-MM-DDTHH-MM-SS-analysis-report-<url>.html`
**Examples:**
- `2026-01-13T14-30-52-analysis-report-www.ecb.europa.eu.html`
...
### 2. Content Creator Reports
Generated when processing individual images or image batches via the Content Creator tool.

**Format:** `YYYY-MM-DDTHH-MM-SS-content-creator-report.html`

**Example:** `2026-01-13T14-30-52-content-creator-report.html`

**Location:** `output/reports/<session-id>/`

**Generated by:**
- Web UI: Content Creator tool (upload images)
...
**Formats:**
- CSV: `prompt_comparison_YYYY-MM-DDTHH-MM-SS.csv`
- HTML: `prompt_comparison_YYYY-MM-DDTHH-MM-SS.html`
- With GEO testing: `prompt_comparison_YYYY-MM-DDTHH-MM-SS_geo_comparison.csv`

**Examples:**
- `prompt_comparison_2026-01-24T15-08-52.csv`
- `prompt_comparison_2026-01-24T15-08-52_geo_comparison.html`
